...
/**
 * Provides the base implementation for the govagency level local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.statisticsmgt.service.impl.GovagencyLevelLocalServiceImpl}.
 * </p>
 *
 * @author trungnt
 * @see org.opencps.statisticsmgt.service.impl.GovagencyLevelLocalServiceImpl
 * @see org.opencps.statisticsmgt.service.GovagencyLevelLocalServiceUtil
 * @generated
 */
public abstract class GovagencyLevelLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements GovagencyLevelLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.statisticsmgt.service.GovagencyLevelLocalServiceUtil} to access the govagency level local service.
	 */

	/**
	 * Adds the govagency level to the database. Also notifies the appropriate model listeners.
	 *
	 * @param govagencyLevel the govagency level
	 * @return the govagency level that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GovagencyLevel addGovagencyLevel(GovagencyLevel govagencyLevel)
	 ...
	 */
	@Override
	public GovagencyLevel createGovagencyLevel(long govagencylevel) {
		return govagencyLevelPersistence.create(govagencylevel);
	}

	/**
	 * Deletes the govagency level with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param govagencylevel the primary key of the govagency level
	 * @return the govagency level that was removed
	 * @throws PortalException if a govagency level with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GovagencyLevel deleteGovagencyLevel(long govagencylevel)
		throws PortalException, SystemException {
		return govagencyLevelPersistence.remove(govagencylevel);
	}

	/**
	 * Deletes the govagency level from the database. Also notifies the appropriate model listeners.
	 *
	 * @param govagencyLevel the govagency level
	 * @return the govagency level that was removed
	 * @throws SystemException if a system exception occurred
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public GovagencyLevel deleteGovagencyLevel(GovagencyLevel govagencyLevel)
		throws SystemException {
		return govagencyLevelPersistence.remove(govagencyLevel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(GovagencyLevel.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return govagencyLevelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return govagencyLevelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public GovagencyLevel fetchGovagencyLevel(long govagencylevel)
		throws SystemException {
		return govagencyLevelPersistence.fetchByPrimaryKey(govagencylevel);
	}

	/**
	 * Returns the govagency level with the primary key.
	 *
	 * @param govagencylevel the primary key of the govagency level
	 ...
	 */
	@Override
	public GovagencyLevel getGovagencyLevel(long govagencylevel)
		throws PortalException, SystemException {
		return govagencyLevelPersistence.findByPrimaryKey(govagencylevel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return govagencyLevelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<GovagencyLevel> getGovagencyLevels(int start, int end)
		throws SystemException {
		return govagencyLevelPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getGovagencyLevelsCount() throws SystemException {
		return govagencyLevelPersistence.countAll();
	}

	/**
	 * Updates the govagency level in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param govagencyLevel the govagency level
	 * @return the govagency level that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public GovagencyLevel updateGovagencyLevel(GovagencyLevel govagencyLevel)
		throws SystemException {
		return govagencyLevelPersistence.update(govagencyLevel);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("org.opencps.statisticsmgt.model.GovagencyLevel",
			govagencyLevelLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = govagencyLevelPersistence.getDataSource();
	...
	private GovagencyLevelLocalServiceClpInvoker _clpInvoker = new GovagencyLevelLocalServiceClpInvoker();
}