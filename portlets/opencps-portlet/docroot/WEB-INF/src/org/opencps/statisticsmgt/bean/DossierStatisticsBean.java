...
public class DossierStatisticsBean {
	...
	public DossierStatisticsBean(DossierStatisticsBean dossierStatisticsBean) {
		...
		this.setDomainItemCode(dossierStatisticsBean.getDomainItemCode());
		this.setDomainTreeIndex(dossierStatisticsBean.getDomainTreeIndex());
		this.setGovItemCode(dossierStatisticsBean.getGovItemCode());
		this.setGovTreeIndex(dossierStatisticsBean.getGovTreeIndex());
		this.setGroupId(dossierStatisticsBean.getGroupId());
		this.setMonth(dossierStatisticsBean.getMonth());
		this.setOntimeNumber(dossierStatisticsBean.getOntimeNumber());
		this.setOvertimeNumber(dossierStatisticsBean.getOvertimeNumber());
		this.setProcessingNumber(dossierStatisticsBean.getProcessingNumber());
		this.setReceivedNumber(dossierStatisticsBean.getReceivedNumber());
		this.setRemainingNumber(dossierStatisticsBean.getRemainingNumber());
		this.setUserId(dossierStatisticsBean.getUserId());
		this.setYear(dossierStatisticsBean.getYear());
