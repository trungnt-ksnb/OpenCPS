...
public class PortletPropsValues {
	...
	public static final String DATAMGT_MASTERDATA_GOVERNMENT_AGENCY = GetterUtil
			.getString(PortletProps
					.get(PortletPropsKeys.DATAMGT_MASTERDATA_GOVERNMENT_AGENCY));
	...
	public static final String USERMGT_JOBPOS_NOMAL = GetterUtil
			.getString(PortletProps.get(PortletPropsKeys.JOBPOS_NOMAL));
	public static final String USERMGT_JOBPOS_BOSS = GetterUtil
			.getString(PortletProps.get(PortletPropsKeys.JOBPOS_LEADER));
	public static final String USERMGT_JOBPOS_DEPUTY = GetterUtil
			.getString(PortletProps.get(PortletPropsKeys.JOBPOS_DEPUTY));
	...
	public static final int DOSSIERMGT_DOSSIER_CONTACT_TEL_NO_LENGTH = GetterUtil
			.getInteger(PortletProps
					.get(PortletPropsKeys.DOSSIERMGT_DOSSIER_CONTACT_TEL_NO_LENGTH));
	...
	public static final String OPENCPS_SERVLET_PREVIEW_DOSSIER_FORM_URL = PortletProps
			.get(PortletPropsKeys.OPENCPS_SERVLET_PREVIEW_DOSSIER_FORM_URL);

	public static final String OPENCPS_SERVLET_VERIFY_SIGN_DOCUMENT_URL = PortletProps
			.get(PortletPropsKeys.OPENCPS_SERVLET_VERIFY_SIGN_DOCUMENT_URL);

	public static final String OPENCPS_SERVLET_EXPORT_FILE_URL = PortletProps
			.get(PortletPropsKeys.OPENCPS_SERVLET_EXPORT_FILE_URL);

	// KeyPay
	public static final String OPENCPS_KEYPAY_CURRENT_LOCATE = PortletProps
			.get(PortletPropsKeys.OPENCPS_KEYPAY_CURRENT_LOCATE);

	public static final String OPENCPS_KEYPAY_COUNTRY_CODE = PortletProps
			.get(PortletPropsKeys.OPENCPS_KEYPAY_COUNTRY_CODE);

	public static final String OPENCPS_KEYPAY_INTERNAL_BANK = PortletProps
			.get(PortletPropsKeys.OPENCPS_KEYPAY_INTERNAL_BANK);

	public static final String OPENCPS_KEYPAY_SERVICE_CODE = PortletProps
			.get(PortletPropsKeys.OPENCPS_KEYPAY_SERVICE_CODE);

	public static final String OPENCPS_KEYPAY_COMMAND = PortletProps
			.get(PortletPropsKeys.OPENCPS_KEYPAY_COMMAND);

	public static final String OPENCPS_KEYPAY_CURRENCY_CODE = PortletProps
			.get(PortletPropsKeys.OPENCPS_KEYPAY_CURRENCY_CODE);

	// Constant values

	public static final String OPENCPS_CANCEL_DOSSIER_NOTICE = PortletProps
			.get(PortletPropsKeys.OPENCPS_CANCEL_DOSSIER_NOTICE);
