...
public class JobPosLocalServiceImpl extends JobPosLocalServiceBaseImpl {
	 ...
	 * org.opencps.usermgt.service.JobPosLocalServiceUtil} to access the job pos
	 * local service.
	 */
	public JobPos addJobPos(long userId, ServiceContext serviceContext,
			String title, String description, long workingUnitId,
			long directWorkingUnitId, int leader) throws SystemException,
			PortalException {

		long jobPosId = CounterLocalServiceUtil.increment(JobPos.class
				.getName());
	...
	public JobPos updateJobPos(long jobPosId, long userId,
			...
			long workingUnitId, long directWorkingUnitId, int leader)
	...
	public void deletejobPos(long jobPosId) throws NoSuchJobPosException,
			SystemException {
	...
	public void mapMultipleWorkingUnitToOneJobPos(long jobPosId,
			long[] workingUnitId) throws SystemException {
		jobPosPersistence.addWorkingUnits(jobPosId, workingUnitId);
	}

	public void mapMultipleEmployeeToOneJobPos(long jobPosId, long[] employeeId)
			throws SystemException {
		jobPosPersistence.addEmployees(jobPosId, employeeId);
	}
}